            ...
            <div class="col-md-4">
                <section class="mb-5">
                    ...
                    <div id="card-shortcut-dir">
                        <a href="http://localhost:<? print $_ENV['PMA_PORT']; ?>" target="_blank" rel="noopener noreferrer" class="font-monospace text-decoration-none">phpMyAdmin <i class="bi bi-table"></i></a><br>
